...
public class EditarAutomovil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edicion de Automovil");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(150, 30, 580, 64);
        ...
        btnGuardarCambios.setBounds(597, 420, 210, 44);
        ...
        btnLimpiar.setBounds(400, 420, 177, 44);
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        controladoraLog.editarAutomovil(this.automovil, modelo, marca, color, motor, patente, cantPuertas);
        
        //MENSAJE DE EDICION EXITOSA:
        mostrarMensaje("Automovil actualizado exitosamente", "Info", "Edicion de Automovil");
    ...
    private void cargarDatosFormulario(int idAutomovil) {
        
        //OBTENER DATOS ACTUALES PARA VISUALIZAR EN LOS CAMPOS DE TEXTO:
        this.automovil = controladoraLog.consultarAutomovil(idAutomovil);
        ...
        txtCantPuertas.setText(automovil.getCantPuertas());
    }
